...
-- Schema Foound
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `Foound` ;
CREATE SCHEMA IF NOT EXISTS `Foound` DEFAULT CHARACTER SET utf8 ;
USE `Foound` ;

-- -----------------------------------------------------
-- Table `Foound`.`STATUS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Foound`.`STATUS` (
...
-- Table `Foound`.`USERS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Foound`.`USERS` (
  ...
  CONSTRAINT `USERS_ID_STATUS_FK`
    ...
    REFERENCES `Foound`.`STATUS` (`ID_STATUS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Foound`.`SPECIALITIES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Foound`.`SPECIALITIES` (
  `ID_SPECIALITY` BIGINT NOT NULL,
  `NAME` VARCHAR(40) NOT NULL,
  PRIMARY KEY (`ID_SPECIALITY`),
  UNIQUE INDEX `ID_SPECIALITY_UNIQUE` (`ID_SPECIALITY` ASC),
  UNIQUE INDEX `NAME_UNIQUE` (`NAME` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `Foound`.`ESTABLISHMENTS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Foound`.`ESTABLISHMENTS` (
  ...
  INDEX `ESTABLISHMENTS_ID_SPECIALITY_FK_idx` (`ID_SPECIALITY` ASC),
  CONSTRAINT `ESTABLISHMENTS_ID_USER_FK`
    FOREIGN KEY (`ID_USER`)
    REFERENCES `Foound`.`USERS` (`ID_USER`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `ESTABLISHMENTS_ID_SPECIALITY_FK`
    FOREIGN KEY (`ID_SPECIALITY`)
    REFERENCES `Foound`.`SPECIALITIES` (`ID_SPECIALITY`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Foound`.`PROMOTIONS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Foound`.`PROMOTIONS` (
  ...
  CONSTRAINT `PROMOTIONS_ID_ESTABLISHMENT_FK`
    ...
    REFERENCES `Foound`.`ESTABLISHMENTS` (`ID_ESTABLISHMENT`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Foound`.`CLIENTS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Foound`.`CLIENTS` (
...
-- -----------------------------------------------------
-- Table `Foound`.`CLIENTS_PROMOTIONS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Foound`.`CLIENTS_PROMOTIONS` (
  ...
  CONSTRAINT `CLIENTS_PROMOTIONS_ID_CLIENT_FK`
    ...
    REFERENCES `Foound`.`CLIENTS` (`ID_CLIENT`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `CLIENTS_PROMOTIONS_ID_PROMOTION_FK`
    FOREIGN KEY (`ID_PROMOTION`)
    REFERENCES `Foound`.`PROMOTIONS` (`ID_PROMOTION`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Foound`.`CLIENTS_PROMOTIONS_HISTORY`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Foound`.`CLIENTS_PROMOTIONS_HISTORY` (
  ...
  CONSTRAINT `CLIENTS_PROMOTIONS_HISTORY_ID_CLIENTS_PROMOTIONS_FK`
    ...
    REFERENCES `Foound`.`CLIENTS_PROMOTIONS` (`ID_CLIENTS_PROMOTIONS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `Foound`.`ROLES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Foound`.`ROLES` (
...
-- -----------------------------------------------------
-- Table `Foound`.`USERS_ROLES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Foound`.`USERS_ROLES` (
  `ID_USER` BIGINT NOT NULL,
  ...
  CONSTRAINT `USERS_ROLES_ID_ROLE_FK`
    FOREIGN KEY (`ID_ROLE`)
    REFERENCES `Foound`.`ROLES` (`ID_ROLE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
